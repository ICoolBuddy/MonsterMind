...
class VibeSfx implements IFlxDestroyable
{
	...
	public function new()
	{
		#if flash
		sounds = [
					 new FlxSoundKludge(AssetPaths.vibe0__mp3, 0.300),
					 new FlxSoundKludge(AssetPaths.vibe1__mp3, 0.227),
					 new FlxSoundKludge(AssetPaths.vibe2__mp3, 0.173),
					 new FlxSoundKludge(AssetPaths.vibe3__mp3, 0.132),
					 new FlxSoundKludge(AssetPaths.vibe4__mp3, 0.100)
				 ];
		#else
		// non-flash targets do not support seamless looping of wavs, so we use longer samples
		// which will loop less frequently
		sounds = [
			new FlxSoundKludge(AssetPaths.vibe0_long__mp3, 0.300),
			new FlxSoundKludge(AssetPaths.vibe1_long__mp3, 0.227),
			new FlxSoundKludge(AssetPaths.vibe2_long__mp3, 0.173),
			new FlxSoundKludge(AssetPaths.vibe3_long__mp3, 0.132),
			new FlxSoundKludge(AssetPaths.vibe4_long__mp3, 0.100)
		];
		#end
	}
