...
class StairDice extends FlxSprite
{
	...
	private function playDiceSfx(volume:Float) {
		SoundStackingFix.play(FlxG.random.getObject([
			AssetPaths.stair_dice0_00cf__mp3,
			AssetPaths.stair_dice1_00cf__mp3,
			AssetPaths.stair_dice2_00cf__mp3,
			AssetPaths.stair_dice3_00cf__mp3,
			AssetPaths.stair_dice4_00cf__mp3,
			AssetPaths.stair_dice5_00cf__mp3,
			]), volume);
	}
